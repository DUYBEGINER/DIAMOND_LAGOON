  ...
  return (
    <section className="min-h-[550px] lg:max-h-[800px]  md:w-full mx-0 md:mx-auto justify-center px-0 lg:px-5 flex flex-col lg:flex-row lg:gap-0 items-stretch bg-[#e8e6e1] py-12 md:py-18 lg:py-25 overflow-hidden">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="order-2 lg:order-1 w-full md:min-w-[450px] px-8 lg:px-0 py-10 lg:w-[35%] lg:pr-10 lg:max-w-[500px] space-y-6 lg:space-y-8 flex flex-col justify-center"
      >
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-[1.8rem] leading-10 whitespace-pre-wrap font-display font-semibold sm:text-[1.9rem] md:text-[2rem] text-[#082B26] tracking-[5px]"
        >
      ...
      <motion.div 
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
        viewport={{ once: true }}
        className="w-full lg:max-w-[900px] order-1 lg:order-2"
      >
